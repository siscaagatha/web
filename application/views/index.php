        ...
        <div class="row">
          <div class="col-sm-4 port-item margin-bottom">
            <div class="item-img-wrap">
              <img src="<?php echo base_url("assets/images/f1.jpg")?>" class="img-responsive" alt="workimg">
              <div class="item-img-overlay">
                <a href="<?php echo base_url("assets/images/f1.jpg")?>" class="show-image">
                  <span></span>
                </a>
              </div>
            </div>
          ...
          <div class="col-sm-4 port-item margin-bottom">
            <div class="item-img-wrap">
              <img src="<?php echo base_url("assets/images/f2.jpg")?>" class="img-responsive" alt="workimg">
              <div class="item-img-overlay">
                <a href="<?php echo base_url("assets/images/f2.jpg")?>" class="show-image">
                  <span></span>
                </a>
              </div>
            </div>
          ...
          <div class="col-sm-4 port-item margin-bottom" >
            <div class="item-img-wrap">
              <img src="<?php echo base_url("assets/images/f3.jpg")?>" class="img-responsive" alt="workimg">
              <div class="item-img-overlay">
                <a href="<?php echo base_url("assets/images/f3.jpg")?>" class="show-image">
                  <span></span>
                </a>
              </div>
            </div>
                        ...
                        <div id="testimonial" class="owl-carousel owl-theme">
                            ...
                            <div class="item">
                                <div class="gambar-testimoni">
                                  <img src="<?php echo base_url("assets/images/wiranto.jpg")?>"/>
                                </div>
                            ...
                            <div class="item">
                                <div class="gambar-testimoni">
                                  <img src="<?php echo base_url("assets/images/mccarthy.jpg")?>"/>
                                </div>
                            ...
                            <div class="item">
                                <div class="gambar-testimoni">
                                  <img src="<?php echo base_url("assets/images/rudiantama.jpg")?>"/>
                                </div>
                            ...
                            <div class="item">
                                <div class="gambar-testimoni">
                                  <img src="<?php echo base_url("assets/images/billgates.jpg")?>"/>
                                </div>
                            ...
                            <div class="item">
                                <div class="gambar-testimoni">
                                  <img src="<?php echo base_url("assets/images/darwin.jpg")?>" />
                                </div>
